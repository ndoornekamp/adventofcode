...
input_file_path = "2023/day17/test_input.txt"
...
while q:
    ...
    for direction in DIRECTIONS:
        if direction == current_direction and n_steps_straight >= 3:
            continue  # Not able to do more than 3 steps in the same direction
