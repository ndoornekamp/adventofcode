...
for brick in tqdm(settled_bricks):
    ...
    if all(b.fall(settled_bricks=bricks_with_brick_removed, update=False) for b in bricks_with_brick_removed):
        ans += 1
    #     print(f"Brick {brick} can safely be disintegrated")
    # else:
    #     print(f"Brick {brick} cannot safely be disintegrated")
    # print()
